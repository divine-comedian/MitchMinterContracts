...
contract deployMitchMinter is Script {
    ...
    address public polygonWETH = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;

    function run() external {
        uint256 deployerPrivateKey = vm.envUint('PRIVATE_KEY');
        string memory baseURI = 'ipfs://QmWkJT5MrHC85mMjgca3B8A3WdcpQsmuXLBQduUuwzHMYz';
        IERC20 paymentToken = IERC20(polygonWETH);
        address rewardTokenAddress = 0x9f830A6562482eB11CA92051cdae820a33777995;
